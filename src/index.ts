...
export { IObject, IObjects } from './objects/objects.js';
export { IMLineStyle, IMLineStyleElement, } from './objects/mlinestyle.js'
...
export { IMLineEntity } from './entities/mline.js';
